...
<div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
    ...
    <div class="flex space-x-3">
        <button onclick="window.parent.openApartmentModal('{{ $apartment->id }}')" 
                class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center">
            <i class="fas fa-edit mr-2"></i> Modifier
        </button>
        <a href="{{ isset($building) ? '/batiments/'.$building->id : '/appartements' }}" 
        ...
        <div class="p-6">
            ...
            <ul class="space-y-3">
                ...
                <li class="flex justify-between">
                    ...
                    <span class="font-medium">45 m²</span>
                </li>
                <li class="flex justify-between">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden border-l-4 border-purple-500">
        <div class="p-6">
            ...
            <div class="flex flex-col items-center justify-center h-full text-center">
                ...
                <a href="/locataires?apartment_id={{ $apartment->id }}" 
...
<div class="bg-white rounded-lg shadow-md overflow-hidden mb-8">
    <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
        ...
        <a href="/locations?apartment_id={{ $apartment->id }}" class="text-sm text-blue-600 hover:text-blue-800">
...
<div class="bg-white rounded-lg shadow-md overflow-hidden">
    <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
        ...
        <a href="/paiements?apartment_id={{ $apartment->id }}" class="text-sm text-blue-600 hover:text-blue-800">
            Voir tout l'historique
        </a>
    </div>
    <div class="p-6">
